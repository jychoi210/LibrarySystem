...
<body>
	<%
	    ...
	    try{
	        ...
	        String query ="SELECT READER.rname, AUTHOR.aname, BOOK.bname, BOOK.bprice FROM READER,AUTHOR,BOOK WHERE READER.rano = AUTHOR.anum AND READER.rano = BOOK.bano AND rnum='"+rnum+"'";
	        ...
	        <tr bgcolor="pink">
	        	...
	        	<td bordercolor="white" style="border-style:double">독자 선호 작가 이름</td>
